...
# Joint positions for the letter 'N' in ASL
asl_n_positions = {
    ...
    **{actuator: 1.6 for finger in ["RingFinger", "LittleFinger"] for actuator in finger_actuators[finger]},
    finger_actuators["RingFinger"][3]: 0.136,  # LittleFingerJoint3_act (knuckle) [-0.436 0.436] positioning the base right.
    finger_actuators["LittleFinger"][3]: 0.136,  # LittleFingerJoint3_act (knuckle) [-0.436 0.436] positioning the base right.
    # Position the thumb
    ...
    **{actuator: 1.2 for finger in ["ForeFinger"] for actuator in finger_actuators[finger]},
    **{actuator: 1.0 for finger in ["MiddleFinger"] for actuator in finger_actuators[finger]},
...
asl_m_positions = {
    ...
    **{actuator: 0.0 for finger in ["ForeFinger", "MiddleFinger", "RingFinger"] for actuator in finger_actuators[finger]},
    ...
    # Close ring finger and little finger
    **{actuator: 1.6 for finger in ["LittleFinger"] for actuator in finger_actuators[finger]},
    finger_actuators["LittleFinger"][3]: 0.136,  # LittleFingerJoint3_act (knuckle) [-0.436 0.436] positioning the base right.
    # Position the thumb
    finger_actuators["Thumb"][0]: 0.0,  # ThumbJoint0_act (distal) [-1.571 0]
    ...
    **{actuator: 1.3 for finger in ["ForeFinger"] for actuator in finger_actuators[finger]},
    **{actuator: 1.2 for finger in ["MiddleFinger"] for actuator in finger_actuators[finger]},
    **{actuator: 1.1 for finger in ["RingFinger"] for actuator in finger_actuators[finger]},
}

asl_revert = { **{actuator: 0.6 for finger in ["ForeFinger", "MiddleFinger"] for actuator in finger_actuators[finger]},
...
for i in range(5):																	
	...
	set_joint_positions(asl_m_positions)
	time.sleep(0.02)  
	
	set_joint_positions(asl_revert,300, 0.03)
	
	# Set the hand to display the letter 'B'
	set_joint_positions(asl_n_positions)
