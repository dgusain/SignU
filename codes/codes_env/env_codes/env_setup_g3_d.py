...
def train_on_gpu(gpu_id: int, num_envs: int, total_timesteps: int, num_steps: int, save_interval: int):
    ...
    model.save(f"/home/easgrad/dgusain/Bot_hand/agents/agent_g3d_{gpu_id}_weighted")

    return callback  # Return the callback to access episode_rewards

def main():
    gpu_id = 6          # Set your GPU ID here
    ...
    plt.grid(True)
    plt.savefig('/home/easgrad/dgusain/Bot_hand/figs/fig_g3d_weighted.png')  # Save the figure
    plt.close()  # Close the figure to free memory
    print("Plot saved as fig_g3d_weighted.png")
