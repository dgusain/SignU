...
def train_on_gpu(gpu_id: int, num_envs: int, total_timesteps: int, num_steps: int, save_interval: int):
    ...
    model.save(f"/home/easgrad/dgusain/Bot_hand/agents/agent_code1_3_gpu{gpu_id}")
...
def main():
    ...
    plt.grid(True)
    plt.savefig('/home/easgrad/dgusain/Bot_hand/figs/fig_code1_3.png')  
    plt.close() 
    print("Plot saved as fig_code1_3.png")
