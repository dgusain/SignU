...
class HandEnv(gym.Env):
    ...
    def step(self, action: np.ndarray):
        ...
        self.set_joint_positions(joint_positions_dict, steps=200, delay=0.02)
...
class RewardCallback(BaseCallback):
    ...
    def _on_step(self) -> bool:
        ...
        self.max_r = max(rewards, self.max_r)
    ...
    def plot_rewards(self):
        ...
        plt.grid()
        #plt.show()
        plt.savefig('/home/dgusain/Bot_hand/figs/fig_train_discrete3.png')
...
def train_on_gpu(gpu_id: int, num_envs: int, episodes: int, steps_per_episode: int):
    ...
    model.save(f"/home/dgusain/Bot_hand/agents/agent_simple_reward")
    return callback
